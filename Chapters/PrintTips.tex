...
Overfull hboxes are elements going over your right margin, which should not happen.
Overfull and underful hboxes are included in your log but you can visualize overfull hboxes using \verb+\setlength{\overfullrule}{20pt}+.
...
Sometimes an overfull hbox is reported but not actually visible because only the invisible part of an element, such as a table, runs over the margin, in which case you can ignore it.
I show you how to fix them in the video \url{https://youtu.be/EeS8p9TGrHw}.
