...
For LaTeX and Git beginners: How to fork our thesis template, make changes and commit them (Linux command line)	&\url{https://youtu.be/QdvhI2qaDUs}\\
Setup LaTeX and Git on Windows	&\url{https://youtu.be/NV0zkvf1GeM}\\
\end{tabulary}
\caption{Videos zu Git und LaTeX.}
\end{table}
...
Die browserbasierte LaTeX-Umgebung \href{https://www.overleaf.com/}{OverLeaf} bietet auch eine Git-Integration, ist aber für Abschlussarbeiten in der kostenlosen Variante nicht geeignet.
