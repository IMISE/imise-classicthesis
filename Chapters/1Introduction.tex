...
Manchmal wird in der Arbeit nur ein Problem P gelöst, das muss dann auch nicht numeriert werden.
...
Warum lohnt es sich, die genannten Probleme zu lösen?				&\enquote{Weil ich mein Studium endlich hinter mir haben will}, \enquote{Damit ich eine gute Note habe.}, \enquote{Weil mein Betreuer es so will.}\\
...
Wer wartet sehnlichst auf die Fertigstellung der Arbeit?		&\enquote{Ich / Mein Betreuer / meine Oma} (außer es ist eine Eigenentwicklung für speziell diese Personen)\\
\end{tabulary}

\section{Zielsetzung}\label{sec:zielsetzung}

Welche Ergebnisse werden mit dieser Abschlussarbeit angestrebt und welche der o.\,g. Probleme sollen damit jeweils gelöst werden?
...
Es sind verschiedene Kombinationen der Zuordnung von Problemen zu Zielen möglich.
Einem Problem sollte mindestens ein Ziel zugeordnet werden, es ist auch möglich, dass es insgesamt nur ein Ziel Z gibt.
...
Bitte geben Sie zu jedem der o.\,g. Ziele mindestens zwei Aufgaben bzw. Fragen an, die bearbeitet bzw. beantwortet werden sollen.
Bitte jede Aufgabe bzw. Frage kurz oder ggf. mit Stichworten beschreiben:
...
Ein positives Beispiel finden Sie in \cref{tab:pos}.
Vermeiden Sie unbedingt, einfach nur die Ziele zu Aufgaben umzuformulieren, siehe \cref{tab:neg}.
...
Ziel						&Aufgabe\\
\midrule
Z1: Analyse der Informationsbedarfe von Wohnungslosen bei der Beratung durch die Leipziger Straßensozialarbeit	&\color{ForestGreen}A1.1 Informationsbeschaffung durch Gespräche, Interviews oder Beobachtungen mit Sozialarbeitenden und Peers\\
																																																								&\color{ForestGreen}A1.2 Ableitung von Informationskategorien wie Unterkunft, Essen und medizinische Versorgung aus den Ergebnissen von A1.1\\
\bottomrule
\end{tabulary}
\caption{Positive Beispiele für die Ableitung von Zielen aus Aufgaben}
\label{tab:pos}
\end{table}
...
Ziel						&Aufgabe\\
\midrule
Z1: Analyse der Informationsbedarfe von Wohnungslosen bei der Beratung durch die Leipziger Straßensozialarbeit	&\color{Sepia}A1.1 Informationsbedarfe von Wohnungslosen bei der Beratung durch die Leipziger Straßensozialarbeit analysieren (umformulierte Aufgabe)\\
																																																								&\color{Sepia}A1.2 Informationsbeschaffung in der Leipziger Straßensozialarbeit (Methoden fehlen)\\
\bottomrule
\end{tabulary}
\caption{Negative Beispiele für die Ableitung von Zielen aus Aufgaben}
\label{tab:neg}
\end{table}
