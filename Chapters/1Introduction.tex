...
\item Ziel(e)/angestrebte(s) Ergebnis(se) zur Lösung des Problems:
	\begin{itemize}
	\item Ziel Z1: Fehlerfreies Transkript nur der fachlichen Inhalte
	\item Ziel Z2: Einhaltung der Datenschutzbestimmungen~\citep{parlament2016verordnung}
	\item Ziel Z3: Beantwortung von Fragen mittels \acp{llm}
	\end{itemize}
...
\item Aufgaben zu Ziel Z2:
	\begin{itemize}
	\item Aufgabe A2.1: Transkipt Anonymisieren/Pseudonymisieren
	\end{itemize}
\item Aufgaben zu Ziel Z3:
	\begin{itemize}
	\item Aufgabe A3.1: Auwahl einer Methode zur Beantwortung von Fragen mithilfe eine Sprachmodells 
	\item Aufgabe A3.2: Auswahl eines Sprachmodells
	\item Aufgabe A3.3: Exemplarische Ausführung der Methode auf das Transkript
	\end{itemize}
\end{itemize}
