...
\begin{itemize}
\item Problem P1: Antwort auf Fachspezifische Fragen zu, Studiengang Medizininformatik finden ist umständlich und zeitaufwendig
\item Problem P2: Identifizierende Personenmerkmale enthalten
...
\item Ziel(e)/angestrebte(s) Ergebnis(se) zur Lösung von Problem P1:
	\begin{itemize}
	\item Ziel Z1.1: Fehlerfreies Transkript nur der fachlichen Inhalte
	\end{itemize}
\item Ziel(e)/angestrebte(s) Ergebnis(se) zur Lösung von Problem P2:
	\begin{itemize}
	\item Ziel Z2.1: Transkript ohne personenbezogene Daten
	\end{itemize}
\item Ziel(e)/angestrebte(s) Ergebnis(se) zur Lösung von Problem P3:
	\begin{itemize}
	\item Ziel Z3.1: Beantwortung von Fragen mittels \acp{llm}
	\end{itemize}
\end{itemize}
...
\item Aufgaben zu Ziel Z1.1:
	\begin{itemize}
	\item Aufgabe A1.1.1: Sichtung der Aufnahmen: Welche Module? Welche Semester? Vollständig? Änderungen?
	\item Aufgabe A1.1.2: Relevante Module auswählen
	\item Aufgabe A1.1.3: Beschaffung und Anpassung der Aufnahmen
	\item Aufgabe A1.1.4: Transkriptionsmodell und Parameter auswählen
	\item Aufgabe A1.1.5: Transkript erstellen
	\item Aufgabe A1.1.6: Transkript säubern
	\end{itemize}
\item Aufgaben zu Ziel Z1.1:
	\begin{itemize}
	\item Aufgabe A1.1.1: Transkipt Anonymisieren/Pseudonymisieren
	\end{itemize}
\item Aufgaben zu Ziel Z3.1:
	\begin{itemize}
	\item Aufgabe A1.1.1: Sichtung der möglichen Sprachmodelle
	\item Auf
	\end{itemize}
\end{itemize}
