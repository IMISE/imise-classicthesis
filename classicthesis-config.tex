...
% ****************************************************************************************************
\newcommand{\myTitle}{Mein Titel mein Titel mein Titel mein Titel mein Titel\xspace}
\newcommand{\mySubtitle}{Mein Untertitel\xspace}
\newcommand{\myDegree}{DEGREE\xspace}
\newcommand{\myName}{Mein Name\xspace}% Nach Prüfungsamt-Vorgabe: Nachname, Vorname
\newcommand{\mybirthday}{dd.mm.yyyy}
\newcommand{\mybirthtown}{Musterstadt}
\newcommand{\mybirthcountry}{Musterland}
\newcommand{\myProf}{Prof. Dr. Alfred Winter\xspace}
\newcommand{\myOtherProf}{Prof. Name2\xspace}
\newcommand{\mySupervisor}{(Dr.) Betreuer Name\xspace}
...
\newcommand{\mySubject}{Informatik B. Sc.\xspace}
...
% ********************************************************************
%\PassOptionsToPackage{american}{babel} % uncomment for English thesis
\PassOptionsToPackage{ngerman}{babel} % comment out for English thesis
...
\usepackage{csquotes}
\PassOptionsToPackage{%
  %backend=biber,bibencoding=auto, %instead of bibtex, can cause errors on Arch Linux using Tectonic if there is a version mismatch
...
% use colored text for template parts to remind students to remove them
\definecolor{temp}{cmyk}{1, 0, 0, 0.5}
\newenvironment{temp}{\color{temp}}
...
\usepackage{cleveref}
% workaround for conflict between cleverref and acronym packages, tested with acronym v1.50
\makeatletter
\AtBeginDocument
 {
