...
\TextField[name=daten,width=17cm,multiline=true,default={
• Identifikationsdaten (z.B. Name, Kontaktdaten)\textCR
• Berufliche Angaben (z.B. Funktion, Tätigkeitsbereich)\textCR
• Audioaufnahmen\textCR
• Inhaltliche Daten aus dem Interview, insbesondere …\textCR
}]{}
